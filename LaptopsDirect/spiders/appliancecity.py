...
class AppliancecitySpider(SitemapSpider):
    ...
    #rules = (
    #  Rule(LinkExtractor(allow=(),deny=(r'^https:\/\/www\.appliancecity.co.uk\/news(.*?)')),callback='parse_item',follow=True),
    #)
    ...
    def parse(self, response):
        ...
        #Scrape Fields
        l.add_xpath('url', '//head//script[@type="text/javascript"][1]/@src')
